...
const themeVariant = localStorage.getItem(CONSTANTS.AIDEN_TRUST_CLIENT_THEME_VARIANT_KEY) ? JSON.parse(localStorage.getItem(CONSTANTS.AIDEN_TRUST_CLIENT_THEME_VARIANT_KEY)) : 'dark';
    ...
    switch (action.type) {
        ...
        case UI_ACTION_TYPES.TOGGLE_THEME:
            localStorage.setItem(
                CONSTANTS.AIDEN_TRUST_CLIENT_THEME_VARIANT_KEY,
