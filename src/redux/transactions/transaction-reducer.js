...
const transactionReducer = (state = INITIAL_STATE, action) => {
    switch (action.type) {
        ...
        case TRANSACTIONS_ACTION_TYPES.CREATE_TRANSACTION_REQUEST:
            return {
                ...state,
                transactionError: null,
                transactionLoading: true
        ...
        case TRANSACTIONS_ACTION_TYPES.CREATE_TRANSACTION_SUCCESS:
            return {
                ...state,
                transactionError: null,
                transactionLoading: false,
        ...
        case TRANSACTIONS_ACTION_TYPES.CREATE_TRANSACTION_FAIL:
            return {
                ...state,
                transactionError: action.payload,
                transactionLoading: false
